...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_17 = QLabel(self.frame_1)
        ...
        self.label_19 = QLabel(self.frame_1)
        ...
        self.gpu_L = QLabel(self.frame_2)
        self.gpu_L.setObjectName(u"gpu_L")

        self.verticalLayout_3.addWidget(self.gpu_L)
        ...
        self.network_L = QLabel(self.frame_2)
        self.network_L.setObjectName(u"network_L")

        self.verticalLayout_3.addWidget(self.network_L)
        ...
        self.start_test_B.setGeometry(QRect(510, 160, 201, 41))
        self.label_12 = QLabel(self.centralwidget)
        self.label_12.setObjectName(u"label_12")
        self.label_12.setGeometry(QRect(510, 10, 85, 16))
        self.label_14 = QLabel(self.centralwidget)
        self.label_14.setObjectName(u"label_14")
        self.label_14.setGeometry(QRect(510, 30, 85, 16))
        self.label_16 = QLabel(self.centralwidget)
        self.label_16.setObjectName(u"label_16")
        self.label_16.setGeometry(QRect(510, 50, 85, 16))
        self.Ping_L = QLabel(self.centralwidget)
        self.Ping_L.setObjectName(u"Ping_L")
        self.Ping_L.setGeometry(QRect(630, 50, 300, 16))
        self.Upload_L = QLabel(self.centralwidget)
        self.Upload_L.setObjectName(u"Upload_L")
        self.Upload_L.setGeometry(QRect(630, 30, 300, 16))
        self.Download_L = QLabel(self.centralwidget)
        self.Download_L.setObjectName(u"Download_L")
        self.Download_L.setGeometry(QRect(630, 10, 300, 16))
        self.Download_L.setMinimumSize(QSize(300, 0))
        self.label_18 = QLabel(self.centralwidget)
        self.label_18.setObjectName(u"label_18")
        self.label_18.setGeometry(QRect(510, 80, 101, 16))
        self.PublicIP_L = QLabel(self.centralwidget)
        self.PublicIP_L.setObjectName(u"PublicIP_L")
        self.PublicIP_L.setGeometry(QRect(630, 80, 300, 16))
        self.LocalIP_L = QLabel(self.centralwidget)
        self.LocalIP_L.setObjectName(u"LocalIP_L")
        self.LocalIP_L.setGeometry(QRect(630, 100, 300, 16))
        self.label_20 = QLabel(self.centralwidget)
        self.label_20.setObjectName(u"label_20")
        self.label_20.setGeometry(QRect(510, 100, 91, 16))
        self.label_21 = QLabel(self.centralwidget)
        self.label_21.setObjectName(u"label_21")
        self.label_21.setGeometry(QRect(510, 130, 91, 16))
        self.MacAddr_L = QLabel(self.centralwidget)
        self.MacAddr_L.setObjectName(u"MacAddr_L")
        self.MacAddr_L.setGeometry(QRect(630, 130, 300, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_18.setText(QCoreApplication.translate("MainWindow", u"\u041f\u0443\u0431\u043b\u0438\u0447\u043d\u044b\u0439 IP:", None))
        ...
        self.label_20.setText(QCoreApplication.translate("MainWindow", u"\u041b\u043e\u043a\u0430\u043b\u044c\u043d\u044b\u0439 IP:", None))
